...
% put here the phases
\begin{phases}
\phase{between month=1 and 2 in 0.3,involvement degree=3.5cm}
\phase{between month=2 and 3 in 0.3,phase color=blue!80!cyan, involvement degree=2.5cm}

\phase{between month=3 and 4 in 0.3,phase color=green!80!cyan, involvement degree=2.5cm}

\phase{between month=4 and 6 in 0.5,phase color=orange!80!cyan, involvement degree=5cm}


\end{phases}

% put here the milestones
\addmilestone{at=phase-1.120,direction=120:1.5cm,text={MRI physics I, II, and III},text options={above}}

\addmilestone{at=phase-2.110,direction=110:3cm,text={Imaging physiology I(basal ganglia)},text options={above}}

\addmilestone{at=phase-3.110,direction=90:1.5cm,text={Imaging physiology II (brain activation) },text 
options={above}}

\addmilestone{at=phase-4.110,direction=100:2.75cm,text={Statistical Analysis(PCA, ICA, fuzzy, clustering) },text 
options={above}}
